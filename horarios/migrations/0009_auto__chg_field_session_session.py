...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'horarios_session', 'session', self.gf('django.db.models.fields.CharField')(max_length=500000))
    ...
    models = {
        ...
        u'horarios.session': {
            ...
            'url': ('django.db.models.fields.CharField', [], {'default': "'SNk46Rd3V2'", 'max_length': '10', 'primary_key': 'True'})
        },
        u'horarios.subject': {
